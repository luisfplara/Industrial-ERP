...
import { Button, LinearProgress, LinearProgressProps, Stack, Typography } from '@mui/material';
import { LineChart } from '@mui/x-charts';
import ProdutosTable from '@/components/tablesViews/produtosTable';
import { ProdutoType, getOneProduto, getProdutos } from '@/models/produto';
import CardItem from '@/components/CardItem';
import { CapacidadeEstoqueChart, EstradaESaidaEstoqueChart } from '@/components/charts/estoque';
import { deleteProdutoEstoque, getEstoques, getOneEstoqueWithId, getProdutosEstoque, getProdutosFromEstoque } from '@/models/estoque';
import DataManupulationHeader from '@/components/DataManupulationHeader';
import Link from 'next/link';
import AddIcon from '@mui/icons-material/Add';
import ProdutosEstoqueTable, { ProdutoEstoqueData } from '@/components/tablesViews/produtosEstoqueTable';
...
export default async function BasicGrid({ params }: { params: { id: string } }) {
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            <DeleteDOCDialog deleteAction={deleteProdutoEstoqueForm} parentId={params.id} />
