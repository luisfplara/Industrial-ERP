...
export default function Page() {
    ...
    const watchCep = watch('dadoEndereco.cep');
    React.useEffect(() => {
...
const FormEndereco = (props: { buscarDadosPorCep: () => Promise<void>, carregandoCidade: boolean, cidades: Cidade[], readOnly: boolean, tipoPessoa: string, register: UseFormRegister<Cliente>, control: Control<Cliente>, errors: FieldErrors<Cliente> }) => {
    ...
    return (<>
        <Grid container spacing={2} marginTop={1}>
            ...
            <Grid item xs={6}>
                <FormControl fullWidth error={!!props.errors?.dadoEndereco?.cidade}>
                    <Controller
                        ...
                        render={({ field }) => (
                            <TextField
                                ...
                                label="Estado"
                                {...field}
                                error={Boolean(!!props.errors.dadoEndereco?.estado)}
                    ...
                    />
                    <FormHelperText>{props.errors?.dadoEndereco?.estado?.message}</FormHelperText>
                </FormControl>
            </Grid>
            <Grid item xs={6}>
                <FormControl fullWidth error={!!props.errors?.dadoEndereco?.cidade}>
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <TextField
                                    ...
                                    {...field}
                                    error={Boolean(!!props.errors.dadoEndereco?.cidade)}
